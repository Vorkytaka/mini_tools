...
class _ExportSizeAlertDialogState extends State<_ExportSizeAlertDialog> {
  ...
  Widget build(BuildContext context) {
    return MacosAlertDialog(
      ...
      title: Text('Write the size'),
      message: Column(
        children: [
          Text(
              'Write the size of exported QR Code in pixels.\n\nIt must be between ${QrCodeState.minExportSize} and ${QrCodeState.maxExportSize}.'),
    ...
    return TitleWithSelector(
      title: FeatureBuilder<QrCodeFeature, QrCodeState>(
        ...
        builder: (context, state) {
          return Text('Export Size (${state.exportSize}px)');
        },
      ),
