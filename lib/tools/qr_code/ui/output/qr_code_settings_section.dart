      ...
      title: Row(
        ...
        children: [
          FeatureBuilder<QrCodeFeature, QrCodeState>(
            ...
            builder: (context, state) {
              return Text(
                '${t.qrCode.correctionLevel.title} ${state.correctionLevel.formatPercentages(context)}',
            ...
            builder: (context, state) {
              ...
              return MiniColorPicker(
                onColorChanged: (color) {
                  if (color != colorFromState(state)) {
                    onColorUpdate(context, color);
                  }
                },
                selectedColor: colorFromState(state),
