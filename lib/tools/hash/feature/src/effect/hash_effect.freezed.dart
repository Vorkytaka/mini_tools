...
abstract class $SyncHashEffectCopyWith<$Res> {
  factory $SyncHashEffectCopyWith(
          SyncHashEffect value, $Res Function(SyncHashEffect) then) =
...
abstract class _$$CountTextHashEffectImplCopyWith<$Res>
    implements $SyncHashEffectCopyWith<$Res> {
  factory _$$CountTextHashEffectImplCopyWith(_$CountTextHashEffectImpl value,
...
class __$$CountTextHashEffectImplCopyWithImpl<$Res>
  ...
  __$$CountTextHashEffectImplCopyWithImpl(_$CountTextHashEffectImpl _value,
  ...
  $Res call({
    ...
    return _then(_$CountTextHashEffectImpl(
      null == text
          ? _value.text
          : text // ignore: cast_nullable_to_non_nullable
              as String,
...
abstract class CountTextHashEffect implements SyncHashEffect {
  const factory CountTextHashEffect(
          final String text, final HashAlgorithm algorithm) =
...
abstract class $IsolateHashEffectCopyWith<$Res> {
  factory $IsolateHashEffectCopyWith(
          IsolateHashEffect value, $Res Function(IsolateHashEffect) then) =
...
abstract class _$$CountFileHashEffectImplCopyWith<$Res>
    implements $IsolateHashEffectCopyWith<$Res> {
  factory _$$CountFileHashEffectImplCopyWith(_$CountFileHashEffectImpl value,
...
class __$$CountFileHashEffectImplCopyWithImpl<$Res>
  ...
  __$$CountFileHashEffectImplCopyWithImpl(_$CountFileHashEffectImpl _value,
  ...
  $Res call({
    ...
    return _then(_$CountFileHashEffectImpl(
      null == path
          ? _value.path
          : path // ignore: cast_nullable_to_non_nullable
              as String,
...
abstract class CountFileHashEffect implements IsolateHashEffect {
  const factory CountFileHashEffect(
          final String path, final HashAlgorithm algorithm) =
